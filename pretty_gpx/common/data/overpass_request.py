...
class OverpassQuery:
    ...
    query_unprocessed_results: dict[str,Result]
    query_cached_results: dict[str,str]

    def __init__(self):
        self.query_dict: dict[str, str] = {}
        self.query_unprocessed_results: dict[str, Result] = {}
        self.query_cached_results: dict[str, str] = {}
...
.{array_name} out skel {out_param};"""
    ...
    def merge_queries(self,
                      timeout_s=300,
                      maxsize_b=1e9) -> tuple[str,list[str]]:
